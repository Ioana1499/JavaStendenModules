...
public class Company
{
     ...
     * @param timeRented The total rental timeOfCollision.
    ...
    /**
     * Print the shortest rent timeOfCollision of an rented speedboat.
     */
    void printShortestRentedSpeedboat()
    {
        ...
        System.out.println( String.format(
                "The shortest rent timeOfCollision is: %s for speedboat: %s it was rented by: %s",

...
public class Main
{
    ...
    private static void executeAction()
    {
        try
        {
            ...
            switch( scanner.nextInt() )
            {
                ...
                case 7:
                    ...
                    System.out.print( "Please type the timeOfCollision the speedboat was rented: " );
                    ...
                    System.out.println( yourRental.isDamage() ? "Thanks for destroying our speedboat, now get out!" : "See you next timeOfCollision!" );
                    break;
        ...
        {
            System.out.println( "You messed up, your an horrible person next timeOfCollision don't break it!" );
        }
    }
    ...
    private static void printMenu()
    {
        ...
        System.out.println( "[ 5 ] - Show speedboat with the shortest rental timeOfCollision" );

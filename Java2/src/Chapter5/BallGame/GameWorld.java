...
public class GameWorld extends JPanel
{
    ...
    private ArrayList<Ball> balls = new ArrayList<>(); // A single bouncing Ball's instance
    private Ball rainbowBall;
    ...
    class DrawCanvas extends JPanel
    {
        ...
        public void paintComponent( Graphics graphics )
        {
            ...
            graphics.drawString( String.format( "Average speed of: %f", balls.stream().mapToDouble( Ball::getSpeed ).sum() / ballAmount  ), 20, getHeight() - 70 );

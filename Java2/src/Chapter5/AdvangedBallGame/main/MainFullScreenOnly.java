...
public class MainFullScreenOnly extends JFrame
{
    ...
    public MainFullScreenOnly()
    {
        ...
        GraphicsDevice device = ScreenUtil.getMainDisplay();

        if( device.isFullScreenSupported() )  // Is full screen mode supported on this display?
        {
        ...
        {    // Run in windowed mode if full screen is not supported
        ...
        BallGame.GameWorld ballWorld = new GameWorld( new Dimension( this.getWidth(), this.getHeight() ) );
